...
<html lang="en">
  ...
  <body>
    ...
    <main>
      <section class="section-servico-1 py-3" id="nossos-servicos">
      ...
      <section class="section-servico-2 py-3" id="musculacao">
        <div class="d-flex align-items-center justify-content-center pt-5">
      ...
      <section class="section-servico-3 py-3" id="crossfit">
        <div class="d-flex align-items-center justify-content-center pt-5">
      ...
      <section class="section-servico-4 py-3" id="pilates">
        <div class="d-flex align-items-center justify-content-center pt-5">
      ...
      <section class="section-servico-5 py-3" id="zumba">
        <div class="d-flex align-items-center justify-content-center pt-5">
